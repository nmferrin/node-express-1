...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2024-03-05T16:11:37.447340" />
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6pi"> How fast is plpgsql?</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Pavel Stehule</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-05</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6p7"> Why I Love psql – PostgreSQL Terminal.</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6p5"> State of the Extension Ecosystem</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Wheeler</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-04</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6p4"> Comparing Postgres Managed Services: AWS, Azure, GCP and Supabase</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6p3"> Open source key areas for digital autonomy</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Jan Karremans</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-04</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6p1"> From dbf to PostgreSQL with Python</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6p0"> Percona Operator for PostgreSQL is Red Hat OpenShift Certified</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6p2"> Divya Sharma</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6oT"> using jq for processing PostgreSQL logs in json format</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Pavel Stehule</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-03-04</li>
            </ul>
